...
data_dic={
    ...
    'qingliangMountain_boundary':r'./data/GIS/phoenixHill_boundary.kml',
...
def boundary_buffer_centroidCircle(kml_extent,proj_epsg,bounadry_type='buffer_circle',buffer_distance=1000):
    ...
    if bounadry_type=='buffer_circle':
        ...
        gpd.GeoDataFrame({'area': c_area,'geometry':b_centroid_buffer},crs=utm).to_crs(wgs84).to_file('./data/GIS/phoenix_b_centroid_buffer.shp')     
        
        b_centroid_gpd=gpd.GeoDataFrame({'x':[b_centroid.x],'y':[b_centroid.y],'geometry':[b_centroid]},crs=utm)# .to_crs(wgs84)
        gpd2postSQL(b_centroid_gpd,table_name='phoenix_b_centroid',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
...
if __name__=="__main__":
    ...
    # road_gdf.plot()
    # gpd2postSQL(road_gdf,table_name='phoenix_road_network',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    ...
    # gpd2postSQL(buildingFootprint,table_name='phoenix_building_footprint',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    
    # d-03_bus routes
    # bus_routes=shp2gdf(data_dic['bus_routes'],epsg=nanjing_epsg,boundary=None,encoding='GBK')
    # bus_routes.plot()
    # gpd2postSQL(bus_routes,table_name='phoenix_bus_routes',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    
    #d-04_bus station
    # bus_stations=shp2gdf(data_dic['bus_stations'],epsg=nanjing_epsg,boundary=boudnary_polygon,encoding='GBK')
    # bus_stations.plot()
    # gpd2postSQL(bus_stations,table_name='phoenix_bus_stations',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    
    #d-05_subway lines
    # subway_lines=shp2gdf(data_dic['subway_lines'],epsg=nanjing_epsg,encoding='GBK')
    # subway_lines.plot()
    # gpd2postSQL(subway_lines,table_name='phoenix_subway_lines',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    ...
    # gpd2postSQL(subway_stations,table_name='phoenix_subway_stations',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    ...
    # gpd2postSQL(population,table_name='phoenix_population',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    ...
    #     gpd2postSQL(g_df_dict[key],table_name='phoenix_taxi_{}'.format(key),myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT') 
    ...
    # gpd2postSQL(POI,table_name='phoenix_poi',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    ...
    # gpd2postSQL(ndvi_cropped,table_name='phoenix_ndvi',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
       
    
    #I-write GeoDataFrame into SQLite database
    # gpd2SQLite(population,db_file,table_name='phoenix_population')
        
    #G-write GeoDataFrame into PostgreSQL 
    # gpd2postSQL(population,table_name='phoenix_population',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    #G-read GeoDataFrame from PostgreSQL
    # population_postsql=postSQL2gpd(table_name='phoenix_population',geom_col='geometry',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
    # population_postsql.plot(column='Population',cmap='hot')
    
    #H-load raster into postGreSQL
    # raster2postSQL(ndvi_fn,table_name='phoenix_ndvi',myusername='postgres',mypassword='123456',mydatabase='workshop-LA-UP_IIT')
